...
public enum MigrationBackup {
    ...
    public static func directory(for dbURL: URL) -> URL {
    ...
    /// pre-image is taken.
    public static func snapshotURL(forDatabaseAt dbURL: URL, fromVersion: Int, now: Date = Date()) -> URL? {
    ...
    public static func metadata(of url: URL) -> (fromVersion: Int, createdAt: Date)? {
    ...
    public static func prunable(_ urls: [URL], keepMostRecent keep: Int) -> [URL] {
    ...
    public static func stamp(_ date: Date) -> String { stampFormatter.string(from: date) }
