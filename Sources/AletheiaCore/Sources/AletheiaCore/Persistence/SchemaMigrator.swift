...
public enum SchemaMigrator {
    ...
    public struct Migration: Equatable {
    ...
    public static var latestVersion: Int { migrations.map(\.version).max() ?? 0 }
    ...
    public static func plan(current: Int, migrations: [Migration] = SchemaMigrator.migrations) -> Plan {
