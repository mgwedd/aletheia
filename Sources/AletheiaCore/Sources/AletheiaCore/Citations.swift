...
public struct CitationSource: Equatable, Identifiable {
    ...
    public init(tag: String, date: Date, folderName: String) {
        self.tag = tag
        self.date = date
...
public struct PatientContext {
    public let text: String
    public let sources: [CitationSource]

    public init(text: String, sources: [CitationSource]) {
        self.text = text
...
public enum Citations {
    ...
    /// session are ignored.
    public static func citedSources(in answer: String, from sources: [CitationSource]) -> [CitationSource] {
    ...
    public static func decorate(answer: String, sources: [CitationSource]) -> String {
        var result = answer
