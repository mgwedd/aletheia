...
public struct PostureItem: Identifiable, Equatable {
    /// Stable key, so SwiftUI identity doesn't depend on the (localized) title.
    public let id: String
    public let title: String
    public let level: PostureLevel
    public let detail: String

    public init(id: String, title: String, level: PostureLevel, detail: String) {
        self.id = id
        self.title = title
        self.level = level
        self.detail = detail
...
public enum SecurityPosture {
    ...
    public static func overall(_ items: [PostureItem]) -> PostureLevel {
