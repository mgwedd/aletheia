...
public enum AudioRetentionPolicy {
    ...
    public static func keepsAudio(optedIn: Bool, encryptionEnabled: Bool) -> Bool {
    ...
    public static func discardsAudioAfterTranscription(optedIn: Bool, encryptionEnabled: Bool) -> Bool {
